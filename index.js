...
const arr=[1,2,3,4,"a",'b','c',8.8,9.77];
arr.forEach(item => {
   console.log(item+" "); 
});
...
//output:1, 2, "x", "y", 4, "a", "b", "c", 8.8, 9.77
arr.splice(2,1,"x","y")
console.log(arr)
...
//reverse
//Reverse the array
//output:"y", "x", "c", "b", "a", 9.77, 8.8, 4, 2, 1
console.log(arr.reverse());

//concat
//concats string
//output:"y", "x", "c", "b", "a", 9.77, 8.8, 4, 2, 1, "xx", "yy"
arr1=["xx","yy"];
console.log(arr.concat(arr1))

//pop
//removes data from array
//output:"y", "x", "c", "b", "a", 9.77, 8.8, 4, 2
arr.pop(1)
console.log(arr)

//push
//adds element into array
//output:"y", "x", "c", "b", "a", 9.77, 8.8, 4, 2, 33
arr.push(33)
console.log(arr)
...
//unshift
//Adds data in array
//output:100, 10000, "x", "c", "b", "a", 9.77, 8.8, 4, 2, 33
